...
parser.add_argument('-b', '--batch-mode' , action="store_true",  dest='batch', help='Do not submit batch job.')
...
elif arg.particle == "12" or arg.particle == "neutrino":
    particleID  = 12
    fileoutBase = "neutrinos"
    outDir      = outDir+"/neutrinos"
    KineticE    = arg.energy
...
ofname = "%s/%d_%gGeV_phi%g_theta%g_x%g_y%g_z%g_%s.lhe"%(outDir,arg.nevts,arg.energy,arg.phi,arg.theta,arg.x,arg.y,arg.z,fileoutBase);
if arg.batch: ofname = "events.lhe";
lhefile = open(ofname, "w")
